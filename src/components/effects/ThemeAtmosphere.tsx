...
const ATMOSPHERES: Record<string, AtmosphereConfig | null> = {
  ...
  'reino-celestial': {
    opacity: 0.5,
    orbs: [
      { x: 15, y: 12, size: 24, color: 'rgba(255, 215, 0, 0.16)', breathe: 9 },
      { x: 82, y: 70, size: 20, color: 'rgba(255, 249, 230, 0.35)', breathe: 12 },
    ],
  ...
  'nova-jerusalem': {
    opacity: 0.5,
    orbs: [
      { x: 20, y: 18, size: 22, color: 'rgba(255, 215, 0, 0.18)', breathe: 10 },
      { x: 78, y: 62, size: 19, color: 'rgba(196, 181, 253, 0.20)', breathe: 13 },
    ],
  },
  'trono-gloria': {
    opacity: 0.55,
    orbs: [
      { x: 50, y: 8, size: 26, color: 'rgba(124, 58, 237, 0.16)', breathe: 11 },
      { x: 84, y: 74, size: 17, color: 'rgba(251, 191, 36, 0.16)', breathe: 9 },
    ],
  ...
  'arca-alianca': {
    opacity: 0.45,
    orbs: [
      { x: 30, y: 20, size: 21, color: 'rgba(217, 119, 6, 0.14)', breathe: 12 },
      { x: 74, y: 68, size: 18, color: 'rgba(146, 64, 14, 0.12)', breathe: 15 },
    ],
  },
  'guerreiro-fe': {
    opacity: 0.5,
    orbs: [
      { x: 18, y: 76, size: 20, color: 'rgba(220, 38, 38, 0.14)', breathe: 8 },
      { x: 80, y: 16, size: 17, color: 'rgba(251, 191, 36, 0.12)', breathe: 10 },
    ],
  },
  'monte-siao': {
    opacity: 0.5,
    orbs: [
      { x: 25, y: 10, size: 25, color: 'rgba(96, 165, 250, 0.16)', breathe: 12 },
      { x: 76, y: 66, size: 20, color: 'rgba(219, 234, 254, 0.35)', breathe: 15 },
    ],
  ...
  'jardim-eden': {
    opacity: 0.5,
    orbs: [
      { x: 16, y: 20, size: 22, color: 'rgba(16, 185, 129, 0.14)', breathe: 11 },
      { x: 82, y: 64, size: 19, color: 'rgba(110, 231, 183, 0.18)', breathe: 14 },
    ],
  ...
  'diamante-promessa': {
    opacity: 0.55,
    orbs: [
      { x: 22, y: 14, size: 24, color: 'rgba(56, 189, 248, 0.16)', breathe: 10 },
      { x: 78, y: 70, size: 19, color: 'rgba(224, 242, 254, 0.4)', breathe: 12 },
    ],
  ...
  'dark-royal': {
    opacity: 0.65,
    orbs: [
      { x: 20, y: 15, size: 24, color: 'rgba(168, 85, 247, 0.20)', breathe: 9 },
      { x: 80, y: 70, size: 20, color: 'rgba(251, 191, 36, 0.12)', breathe: 12 },
    ],
  ...
  'sabedoria': {
    opacity: 0.4,
    orbs: [
      { x: 24, y: 16, size: 22, color: 'rgba(30, 64, 175, 0.10)', breathe: 14 },
      { x: 78, y: 68, size: 18, color: 'rgba(59, 130, 246, 0.10)', breathe: 16 },
    ],
  },
  'noite-oracao': {
    opacity: 0.65,
    orbs: [
      { x: 70, y: 12, size: 17, color: 'rgba(245, 243, 255, 0.14)', breathe: 13 },
      { x: 20, y: 60, size: 24, color: 'rgba(124, 58, 237, 0.18)', breathe: 10 },
    ],
  ...
  'pentecostes': {
    opacity: 0.5,
    orbs: [
      { x: 50, y: 82, size: 23, color: 'rgba(249, 115, 22, 0.14)', breathe: 8 },
      { x: 18, y: 20, size: 17, color: 'rgba(251, 191, 36, 0.12)', breathe: 10 },
    ],
