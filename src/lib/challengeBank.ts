...
export const CHALLENGE_BANK: BankChallenge[] = [
  ...
  { category: 'gratidao', challenge_text: '🌻 Escreva três motivos pelos quais você é grato hoje e compartilhe no Feed.', motivational_quote: 'Em tudo dai graças. — 1 Tessalonicenses 5:18', difficulty_level: 'facil', points_reward: 10 },
...
export const CATEGORY_LINKS: Record<string, { path: string; label: string }> = {
  ...
  gratidao: { path: '/feed', label: 'Ir para o Feed' },
