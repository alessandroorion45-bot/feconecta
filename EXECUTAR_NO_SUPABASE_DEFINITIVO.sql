-- =====================================================
-- DEPLOY PAINEL ADMIN - VERSÃO DEFINITIVA
-- =====================================================
-- CORRIGIDO: users.id em vez de users.user_id
-- =====================================================
...
BEGIN
  ...
  -- CORRIGIDO: users.id em vez de users.user_id
  UPDATE users SET is_banned = true, banned_at = NOW(), banned_by = p_admin_id WHERE id = p_user_id;
...
-- =====================================================
-- PARTE 5: VIEWS (CORRIGIDAS - users.id)
-- =====================================================
...
-- CORRIGIDO: JOIN com users.id em vez de users.user_id
