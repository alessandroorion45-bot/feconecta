-- =====================================================
-- LIMPAR TODAS AS TABELAS E VIEWS DO PAINEL ADMIN
-- =====================================================
-- Execute PRIMEIRO para limpar conflitos
-- =====================================================

-- Dropar views (para não dar erro de dependência)
...
-- Verificar limpeza
SELECT 'LIMPEZA CONCLUÍDA! Agora execute o SQL principal.' as status;
